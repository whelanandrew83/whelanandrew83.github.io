...
const compareColumns = {
    ...
    "DecSets": { name: "Deciding Sets", dec: 0 },
    "DecSetWinPercentage": { name: "Deciding Sets Won %", dec: 1 },
    "TieBreaks": { name: "Tie Breaks", dec: 0 },
    "TieBreaksWonPercentage": { name: "Tie Breaks Won %", dec: 1 },
    "EloHeading": { name: "Elo Stats", heading: true },
