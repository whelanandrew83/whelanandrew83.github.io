...
const statsColumns = {
    ...
    "Difference": ["RatingPoints_Diff", "Supercoach_Diff", "DreamTeamPoints_Diff", "CoachesVotes_Diff", "Kicks_Diff", "Handballs_Diff", "Disposals_Diff", "Inside50s_Diff", "MetresGained_Diff", "Clangers_Diff", "Turnovers_Diff", "ContestedPossessions_Diff", "UncontestedPossessions_Diff", "TotalPossessions_Diff", "Intercepts_Diff", "GroundBallGets_Diff", "CentreClearances_Diff", "StoppageClearances_Diff", "TotalClearances_Diff", "Marks_Diff", "ContestedMarks_Diff", "MarksInside50_Diff", "InterceptMarks_Diff", "MarksOnLead_Diff", "Goals_Diff", "Behinds_Diff", "ShotsAtGoal_Diff", "GoalAssists_Diff", "ScoreInvolvements_Diff", "ScoreLaunches_Diff", "xScore_Diff", "xScoreRating_Diff", "xScorePerShot_Diff", "PointsFromKickIn_Diff", "PointsFromStoppage_Diff", "PointsFromTurnover_Diff", "PointsFromDefensiveHalf_Diff", "PointsFromForwardHalf_Diff", "PointsFromCentreBounce_Diff", "Tackles_Diff", "TacklesInside50_Diff", "PressureActs_Diff", "Spoils_Diff", "Hitouts_Diff", "HitoutsToAdvantage_Diff", "Bounces_Diff", "OnePercenters_Diff"]
};
