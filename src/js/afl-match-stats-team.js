...
const scoreDisplay = function (cellInfo, goalsField, behindsField, scoreField) {
    return `${cellInfo.row[goalsField]}.${cellInfo.row[behindsField]}.${cellInfo.row[scoreField]}`
}
