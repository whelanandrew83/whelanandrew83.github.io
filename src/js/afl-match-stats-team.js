...
const columnsAlwaysDisplayed = ["Season", "RoundNumber", "Match", "MatchId", "Team", "Opposition", "Result", "Margin", "xMargin", "xWins"];
...
const statsColumns = {
    "For": ["Age", "Experience", "CoachesVotes", "RatingPoints", "Supercoach", "DreamTeamPoints", "Kicks", "Handballs", "Disposals", "DisposalEfficiency", "MetresGained", "Inside50s", "ForwardHalf", "ContestedPossessions", "GroundBallGets", "PostClearanceContestedPossessions", "PostClearanceGroundBallGets", "Intercepts", "TotalClearances", "FirstPossessions", "FirstPossessionToClearance", "Marks", "ContestedMarks", "InterceptMarks", "ShotsAtGoal", "Goals", "Behinds", "Score", "xScore", "xScoreRating", "GoalAssists", "Tackles", "Hitouts", "Equity_PreClearance", "Equity_PostClearance", "Equity_Possession", "Equity_BallUse,", "ChainToScore", "D50ToF50", "D50ToScore", "DefHalfToF50", "DefHalfToScore", "xChainScore", "xChainScoreFromStoppage", "xChainScoreFromTurnover", "GoalsFromKickIn", "BehindsFromKickIn", "PointsFromKickIn", "GoalsFromStoppage", "BehindsFromStoppage", "PointsFromStoppage", "GoalsFromTurnover", "BehindsFromTurnover", "PointsFromTurnover", "GoalsFromDefensiveHalf", "BehindsFromDefensiveHalf", "PointsFromDefensiveHalf", "GoalsFromForwardHalf", "BehindsFromForwardHalf", "PointsFromForwardHalf", "GoalsFromCentreBounce", "BehindsFromCentreBounce", "PointsFromCentreBounce"],
    "Against": ["Age_Opposition", "Experience_Opposition", "RatingPoints_Opposition", "Kicks_Opposition", "Handballs_Opposition", "Disposals_Opposition", "MetresGained_Opposition", "Inside50s_Opposition", "ContestedPossessions_Opposition", "GroundBallGets_Opposition", "PostClearanceContestedPossessions_Opposition", "PostClearanceGroundBallGets_Opposition", "Intercepts_Opposition", "TotalClearances_Opposition", "FirstPossessions_Opposition", "FirstPossessionToClearance_Opposition", "Marks_Opposition", "ContestedMarks_Opposition", "InterceptMarks_Opposition", "ShotsAtGoal_Opposition", "Goals_Opposition", "Behinds_Opposition", "Score_Opposition", "xScore_Opposition", "xScoreRating_Opposition", "GoalAssists_Opposition", "Tackles_Opposition", "Equity_PreClearance_Opposition", "Equity_PostClearance_Opposition", "Equity_Possession_Opposition", "Equity_BallUse_Opposition", "ChainToScore_Opposition", "D50ToF50_Opposition", "D50ToScore_Opposition", "DefHalfToF50_Opposition", "DefHalfToScore_Opposition", "xChainScore_Opposition", "xChainScoreFromStoppage_Opposition", "xChainScoreFromTurnover_Opposition", "GoalsFromKickIn_Opposition", "BehindsFromKickIn_Opposition", "PointsFromKickIn_Opposition", "GoalsFromStoppage_Opposition", "BehindsFromStoppage_Opposition", "PointsFromStoppage_Opposition", "GoalsFromTurnover_Opposition", "BehindsFromTurnover_Opposition", "PointsFromTurnover_Opposition", "GoalsFromDefensiveHalf_Opposition", "BehindsFromDefensiveHalf_Opposition", "PointsFromDefensiveHalf_Opposition", "GoalsFromForwardHalf_Opposition", "BehindsFromForwardHalf_Opposition", "PointsFromForwardHalf_Opposition", "GoalsFromCentreBounce_Opposition", "BehindsFromCentreBounce_Opposition", "PointsFromCentreBounce_Opposition"],
    "Difference": ["Age_Diff", "Experience_Diff", "RatingPoints_Diff", "Kicks_Diff", "Handballs_Diff", "Disposals_Diff", "MetresGained_Diff", "Inside50s_Diff", "ContestedPossessions_Diff", "GroundBallGets_Diff", "PostClearanceContestedPossessions_Diff", "PostClearanceGroundBallGets_Diff", "Intercepts_Diff", "TotalClearances_Diff", "FirstPossessions_Diff", "Marks_Diff", "ContestedMarks_Diff", "InterceptMarks_Diff", "ShotsAtGoal_Diff", "xScoreRating_Diff", "GoalAssists_Diff", "Tackles_Diff", "Equity_PreClearance_Diff", "Equity_PostClearance_Diff", "Equity_Possession_Diff", "Equity_BallUse_Diff", "xChainScore_Diff", "xChainScoreFromStoppage_Diff", "xChainScoreFromTurnover_Diff", "PointsFromKickIn_Diff", "PointsFromStoppage_Diff", "PointsFromTurnover_Diff", "PointsFromDefensiveHalf_Diff", "PointsFromForwardHalf_Diff", "PointsFromCentreBounce_Diff"]
};
...
const filterColumns = {
    ...
    "PostClearanceContestedPossessions_Diff": "Post-Clearance Contested Possessions (Difference)",
    "PostClearanceGroundBallGets_Diff": "Post-Clearance Ground Ball Gets (Difference)",
