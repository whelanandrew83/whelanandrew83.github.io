    ...
    xmlhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            ...
            if (player_data) {
                ...
                h1.innerText = `Match Stats - ${player_data.Summary.Team}`;
                document.title = `AFL Match Stats - ${player_data.Summary.Team}`;
