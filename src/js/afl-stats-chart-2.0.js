const chartColumns = {
    ...
    "AssistedMetresGained": { name: "Assisted Metres Gained" },
    "NetMetresGained": { name: "Net Metres Gained" },
    "RetainedMetresGained": { name: "Retained Metres Gained" },
    "KickMetresGained": { name: "Kick Metres Gained" },
    "HandballMetresGained": { name: "Handball Metres Gained" },
    "Turnovers": { name: "Turnovers" },
    "DisposalRetentionPercentage": { name: "Disposal Retention %" },
    "KickIntoF50RetentionPercentage": { name: "Kick Into F50 Retention %" },
    "Equity_PreClearance": { name: "Pre-Clearance Equity" },
    "Equity_PostClearance": { name: "Post-Clearance Equity" },
    "Equity_Possession": { name: "Ball Winning Equity" },
    "Equity_BallUse": { name: "Ball Use Equity" },
    ...
    "ScoreAssists": { name: "Score Assists" },
    "ScoreboardImpact": { name: "Scoreboard Impact" },
