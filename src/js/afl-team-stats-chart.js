const chartColumns = {
    ...
    "GroundBallGets_Diff": { name: "Ground Ball Gets (Opposition)" },
    "HardBallGets_Diff": { name: "Hard Ball Gets (Opposition)" },
    "LooseBallGets_Diff": { name: "Loose Ball Gets (Opposition)" },
