...
const statsColumnsAll = ["Age_Decimal", "Team", "Image", "RatingPoints_Avg", "Supercoach_Avg",
    ...
    "GroundBallGets", "GroundBallGetsForward50", "HardBallGets", "LooseBallGets", "GathersFromHitout", "CrumbingPossessions", "HandballReceives",
    "PostClearanceContestedPossessions", "PostClearanceGroundBallGets",
...
const statsColumns = {
    ...
    "Possessions": {
        ...
        "PostClearanceContestedPossessions": "Post-Clearance Contested Possessions", "PostClearanceGroundBallGets": "Post-Clearance Ground Ball Gets",
    },
