const chartColumns = {
    ...
    "KickMetresGained": { name: "Kick Metres Gained", dec: 0 },
    "HandballMetresGained": { name: "Handball Metres Gained", dec: 0 },
    ...
    "HitoutsToAdvantage": { name: "Hitouts To Advantage", dec: 0 },
    "HitoutToFirstPossession": { name: "Hitout To First Possession", dec: 1 },
    "FirstPossessions": { name: "First Possessions", dec: 0 },
    "FirstPossessionToClearance": { name: "First Possession To Clearance %", dec: 1 },
    "TotalClearances": { name: "Total Clearances", dec: 0 },
    "CentreClearances": { name: "Centre Clearances", dec: 0 },
    ...
    "ScoresPerInside50": { name: "Scores per Inside 50", dec: 1 },
    ...
    "ChainToScore": { name: "Chain To Score %", dec: 1 },
    "D50ToF50": { name: "Defensive 50 To Inside 50 %", dec: 1 },
    "D50ToScore": { name: "Defensive 50 To Score %", dec: 1 },
    "DefHalfToF50": { name: "Defensive Half To Inside 50 %", dec: 1 },
    "DefHalfToScore": { name: "Defensive Half To Score %", dec: 1 },
    "xChainScore": { name: "xChainScore", dec: 1 },
    "xChainScoreFromStoppage": { name: "xChainScore from Stoppage", dec: 1 },
    "xChainScoreFromTurnover": { name: "xChainScore from Turnover", dec: 1 },
    ...
    "KickMetresGained_Opposition": { name: "Kick Metres Gained (Opposition)", dec: 0 },
    "HandballMetresGained_Opposition": { name: "Handball Metres Gained (Opposition)", dec: 0 },
    ...
    "Hitouts_Opposition": { name: "Hitouts (Opposition)", dec: 0 },
    "HitoutsToAdvantage_Opposition": { name: "Hitouts To Advantage (Opposition)", dec: 0 },
    "HitoutToFirstPossession_Opposition": { name: "Hitout To First Possession (Opposition)", dec: 1 },
    "FirstPossessions_Opposition": { name: "First Possessions (Opposition)", dec: 0 },
    "FirstPossessionToClearance_Opposition": { name: "First Possession To Clearance % (Opposition)", dec: 1 },
    "TotalClearances_Opposition": { name: "Total Clearances (Opposition)", dec: 0 },
    "CentreClearances_Opposition": { name: "Centre Clearances (Opposition)", dec: 0 },
    ...
    "ScoresPerInside50_Opposition": { name: "Scores per Inside 50 (Opposition)", dec: 1 },
    "GoalAssists_Opposition": { name: "Goal Assists (Opposition)", dec: 0 },
    "Equity_PreClearance_Opposition": { name: "Pre-Clearance Equity (Opposition)", dec: 1 },
    "Equity_PostClearance_Opposition": { name: "Post-Clearance Equity (Opposition)", dec: 1 },
    "Equity_Possession_Opposition": { name: "Ball Winning Equity (Opposition)", dec: 1 },
    "Equity_BallUse_Opposition": { name: "Ball Use Equity (Opposition)", dec: 1 },
    "ChainToScore_Opposition": { name: "Chain To Score % (Opposition)", dec: 1 },
    "D50ToF50_Opposition": { name: "Defensive 50 To Inside 50 % (Opposition)", dec: 1 },
    "D50ToScore_Opposition": { name: "Defensive 50 To Score % (Opposition)", dec: 1 },
    "DefHalfToF50_Opposition": { name: "Defensive Half To Inside 50 % (Opposition)", dec: 1 },
    "DefHalfToScore_Opposition": { name: "Defensive Half To Score % (Opposition)", dec: 1 },
    "xChainScore_Opposition": { name: "xChainScore (Opposition)", dec: 1 },
    "xChainScoreFromStoppage_Opposition": { name: "xChainScore from Stoppage (Opposition)", dec: 1 },
    "xChainScoreFromTurnover_Opposition": { name: "xChainScore from Turnover (Opposition)", dec: 1 },
    ...
    "KickMetresGained_Diff": { name: "Kick Metres Gained (Difference)", dec: 0 },
    "HandballMetresGained_Diff": { name: "Handball Metres Gained (Difference)", dec: 0 },
    ...
    "Hitouts_Diff": { name: "Hitouts (Difference)", dec: 0 },
    "HitoutsToAdvantage_Diff": { name: "Hitouts To Advantage (Difference)", dec: 0 },
    "FirstPossessions_Diff": { name: "First Possessions (Difference)", dec: 0 },
    "TotalClearances_Diff": { name: "Total Clearances (Difference)", dec: 0 },
    "CentreClearances_Diff": { name: "Centre Clearances (Difference)", dec: 0 },
    ...
    "Equity_PreClearance_Diff": { name: "Pre-Clearance Equity (Difference)", dec: 1 },
    "Equity_PostClearance_Diff": { name: "Post-Clearance Equity (Difference)", dec: 1 },
    "Equity_Possession_Diff": { name: "Ball Winning Equity (Difference)", dec: 1 },
    "Equity_BallUse_Diff": { name: "Ball Use Equity (Difference)", dec: 1 },
    "xChainScore_Diff": { name: "xChainScore (Difference)", dec: 1 },
    "xChainScoreFromStoppage_Diff": { name: "xChainScore from Stoppage (Difference)", dec: 1 },
    "xChainScoreFromTurnover_Diff": { name: "xChainScore from Turnover (Difference)", dec: 1 },
